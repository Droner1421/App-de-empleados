...
interface Props extends DrawerScreenProps<ReportesDrawerParams, 'ReporteAsistenciaScreen'> {}
    ...
    const renderItem = ({ item }: { item: AsistenciaItem }) => (
        <View style={style.card}>
            ...
            <View style={style.row}>
                ...
                <Text style={[style.value, { color: '#FF6700', fontWeight: '700' }]}>{item.a_horaEntrada}</Text>
            </View>
            <View style={style.row}>
            ...
            <View style={[style.row, style.rowLast]}>
                ...
                <Text style={[style.value, { color: '#CC5200', fontWeight: '700' }]}>{item.a_turno}</Text>
            </View>
        </View>
    );
